package com.bioxx.sf.TileEntites;
...
import com.bioxx.sf.Networking.AbstractPacket;
import com.bioxx.sf.Networking.DataBlockPacket;
...
public abstract class NetworkTileEntity extends TileEntity
{
	...
	public void broadcastPacketInRange()
	{
		...
		if(worldObj.isRemote)
			StellarForge.packetPipeline.sendToServer(this.createDataPacket());
		else
			StellarForge.packetPipeline.sendToAllAround(this.createDataPacket(), 
	...
	{
		if(worldObj.isRemote)
			StellarForge.packetPipeline.sendToServer(packet);
		else
			StellarForge.packetPipeline.sendToAllAround(packet, 
